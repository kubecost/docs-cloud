...
![Collections](/images/collections-cloud.png)
...
{% hint style="info" %}
Your cloud provider may not provide a Resource ID for all cloud 'items'. Cloud costs without an associated resource ID are not supported today.
{% endhint %}
